...
<form method="POST" action="<?php echo e(route('storequestion')); ?>" class="form-select">
    <?php echo csrf_field(); ?>
    <div class="form-group">
        <label for="">Catégorie</label>
        <select name="categorie" id="">
            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categorie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($categorie->categorie); ?>"><?php echo e($categorie->categorie); ?></option>
...
<?php echo $__env->make('base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\CultureQuizz\back\resources\views/createQuestion.blade.php ENDPATH**/ ?>